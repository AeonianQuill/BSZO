#!/bin/bash
# =============================================================================
# BSZO-V4 experiments for Mistral-7B
# Datasets: WSC, Copa, TREC, WIC
#
# Usage:
#   Single dataset:  ./run_bszo_v4_mistral7b.sh WSC 0
#   All sequential:  ./run_bszo_v4_mistral7b.sh all 0
#   Two GPUs parallel: CUDA_VISIBLE_DEVICES=2,3 ./run_bszo_v4_mistral7b.sh all_parallel
#
# Examples:
#   ./run_bszo_v4_mistral7b.sh WSC 0           # WSC on GPU 0
#   ./run_bszo_v4_mistral7b.sh Copa 1          # Copa on GPU 1
#   CUDA_VISIBLE_DEVICES=0,1 ./run_bszo_v4_mistral7b.sh all_parallel
#   CUDA_VISIBLE_DEVICES=2,3 ./run_bszo_v4_mistral7b.sh all_parallel
# =============================================================================
...
run_task() {
    local TASK=$1
    local GPU=$2
    export WANDB_PROJECT="v4_${TASK,,}_mistral7b_ft"
    ...
    for lr in "${LRS[@]}"; do
        echo "======================================"
        echo "GPU ${GPU} | BSZO-V4 | ${TASK} | lr=${lr}"
        ...
        CUDA_VISIBLE_DEVICES=$GPU python run.py \
            ...
            --task_name=${TASK} \
            --output_dir=result/bszo_v4_mistral7b_${TASK}_lr${lr} \
            --num_train_epochs=5 \
...
run_parallel() {
    ...
    echo "GPU ${GPU0}: WSC, TREC"
    echo "GPU ${GPU1}: Copa, WIC"
...
echo "BSZO-V4 Mistral-7B experiments completed!"
